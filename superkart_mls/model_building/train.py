...
categorical_features = ['Product_Store_Sales_Total']
...
# Save best model
joblib.dump(best_model, "best_supercartsalesforecast_v1.joblib")

# Upload to Hugging Face
repo_id = "jeevachandru/SuperCart_SalesForecast"
repo_type = "model"
...
api.upload_file(
    path_or_fileobj="best_supercartsalesforecast_v1.joblib",
    path_in_repo="best_supercartsalesforecast_v1.joblib",
    repo_id=repo_id,
    repo_type=repo_type,
)
